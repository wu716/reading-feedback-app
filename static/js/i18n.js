(function () {
    ...
    const messages = {
        'zh-CN': {
            ...
            'schedule.familiarityLabel': '熟悉度',
            'schedule.importanceLabel': '重要性',
            ...
            'schedule.hint.design': '这里只设置任务属性；修改任务请回到清单',
            'schedule.hint.sort': '这里只调整顺序和并行关系',
            'schedule.hint.done': '今日已完成',
            'schedule.hint.flow': '勾选完成，也可记下执行情况。点任务内容即可修改，也可删除',
            'schedule.hint.list': '添加时可直接标注熟悉度和重要性，清单中可填写执行反馈',
        ...
        en: {
            ...
            'schedule.note': 'Execution feedback',
            ...
            'schedule.familiarityLabel': 'Familiarity',
            'schedule.importanceLabel': 'Importance',
            ...
            'schedule.hint.design': 'Only set task attributes here; return to the list to edit tasks.',
            'schedule.hint.sort': 'Only adjust order and parallel relationships here.',
            'schedule.hint.done': 'Today is complete',
            'schedule.hint.flow': 'Check items off, add execution notes, or click a task to edit it.',
            'schedule.hint.list': 'Set familiarity and importance while adding; record execution feedback in the list.',
