(function () {
    ...
    const messages = {
        'zh-CN': {
            ...
            'schedule.add.placeholder': '写下这一步',
            'schedule.add.button': '写下',
            'schedule.edit': '修改',
            'schedule.delete': '删除',
            ...
            'schedule.hint.flow': '勾选完成，也可记下执行情况。写错了点「修改」，也可删除',
            'schedule.hint.list': '写下今天要做的事。写错了点「修改」，也可拆开或删除',
        ...
        en: {
            ...
            'schedule.add.placeholder': 'Write the next step',
            ...
            'schedule.hint.flow': 'Check items off, or add execution notes. Use Edit to fix mistakes.',
            'schedule.hint.list': 'Write what you will do today. Use Edit, Break down, or Delete when needed.',
