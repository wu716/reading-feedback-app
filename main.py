...
from app.routers import auth, actions, practice, dashboard, ai_advice, today, app_download, owner, schedule, time_log, capture, habit_programs
...
STATIC_UI_VERSION = "20260920habit1"
NO_STORE_HEADERS = {
